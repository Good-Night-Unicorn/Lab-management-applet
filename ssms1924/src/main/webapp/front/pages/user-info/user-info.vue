<template>
	<view class="content">
		...
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='yonghuxinxi'" class="cu-form-group">
			...
			<input  style="padding: 0 30upx" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(230, 230, 230, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.xuehao" placeholder="学号"></input>
		</view>
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='yonghuxinxi'" class="cu-form-group">
