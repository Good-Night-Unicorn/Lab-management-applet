<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验室状态" prop="shiyanshizhuangtai">
          <el-input v-model="ruleForm.shiyanshizhuangtai" 
              placeholder="实验室状态" clearable  :readonly="ro.shiyanshizhuangtai"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    shiyanshihaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.shiyanshiweizhi){
                this.ruleForm.shiyanshiweizhi = data.data.shiyanshiweizhi
              }
              if(data.data.shiyanshizhuangtai){
                this.ruleForm.shiyanshizhuangtai = data.data.shiyanshizhuangtai
              }
        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yudingshiyanshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yudingshiyanshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
