    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课表简介" prop="kebiaojianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.kebiaojianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kebiaojianjie" label="课表简介" prop="kebiaojianjie">
                    <span v-html="ruleForm.kebiaojianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kebiaojianjie = this.ruleForm.kebiaojianjie.replace(reg,'../../../ssms1924/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
