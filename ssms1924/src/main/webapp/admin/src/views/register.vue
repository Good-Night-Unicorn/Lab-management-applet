  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">实验室管理微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="学号" class="input" v-if="tableName=='yonghuxinxi'">
			...
			<el-form-item label="班级" class="input" v-if="tableName=='yonghuxinxi'">
